<template>
    <div class="col1">
        ...
        <img v-else-if="product.image" :src="uploads + product.image" />
        <div class="imageActions">
            <input type="file" id="file" accept="image/*" @change="onFileChange" v-if="!product.image && !imageData" >
            <p class="danger" v-if="!product.image && !imageData">Please upload image</p>
            <label for="file" v-if="!product.image && !imageData">
                <span>
