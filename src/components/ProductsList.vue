    ...
    <div class="container content_box">
        <div class="content_box_top">
            ...
            <div class="search_wrap">
                <input type="search" id="Search" @keyup.enter="getList(1)" v-model="searchText" placeholder="Search">
            ...
            <div>
                <router-link :to="{ name: 'ProductActions', params:{id: 'new'}}">
        ...
        <div class="content_box_center">
            <product @updateList="getList" v-for="product in this.list" :product="product" :key="product.id"></product>
        </div>
        <div class="content_box_bottom">
            <pagination @change="getPage" :total="parseInt(this.howPages)" :value="this.currentPage"></pagination>
        </div>
    </div>
</template>
